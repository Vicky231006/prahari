...
CREATE TABLE IF NOT EXISTS identity_profiles (
    ...
    typical_channels        JSONB   DEFAULT '[]',
    preferred_payment_method VARCHAR(64),
    device_trust_score      FLOAT   DEFAULT 0,
